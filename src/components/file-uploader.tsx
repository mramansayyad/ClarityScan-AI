    ...
    <div className="w-full h-full flex flex-col items-center justify-center gap-8 text-center py-12 lg:py-24">
        <div className="w-full max-w-3xl">
            ...
            <p className="mt-4 text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
                Simply upload a document or image. Our AI will perform a comprehensive analysis, extracting key data and providing valuable insights in seconds.
            </p>
        </div>
        <div
            onClick={handleClick}
            ...
            className={cn(
                ...
                isDragging ? 'border-primary bg-primary/10 scale-105 shadow-2xl shadow-primary/20' : 'border-border/50 bg-card/50 hover:border-primary/50 hover:bg-accent/10'
            )}
        >
            <input
                ref={fileInputRef}
            ...
            <div className="flex flex-col items-center gap-4 text-muted-foreground transition-colors duration-300">
                <div className={cn('w-20 h-20 rounded-full bg-card flex items-center justify-center transition-all duration-300', isDragging ? 'bg-primary/20 scale-110' : 'group-hover:bg-accent/20')}>
                    <UploadCloud className={cn('w-10 h-10 transition-transform group-hover:scale-110', isDragging ? 'text-primary' : '')} />
                </div>
                ...
                <div className="text-xs flex items-center justify-center gap-4 flex-wrap px-4">
                  ...
                  <span className="flex items-center gap-1"><FileText className="w-3 h-3" /> Text Files</span>
                  <span className="flex items-center gap-1"><File className="w-3 h-3" /> Documents</span>
                </div>
            </div>
        </div>
    </div>
